...
namespace Slate
{
    ...
    public class BezierPathEditor : Editor
    {
        ...
        void DrawPointSceneGUI(BezierPoint point, int index) {
            ...
            var fmh_82_52_638617347013772013 = Quaternion.identity; Handles.FreeMoveHandle(point.position, pointGUISize, Vector3.zero, Handles.RectangleHandleCap);
            ...
            var fmh_90_76_638617347013787606 = Quaternion.identity; var newGlobal1 = Handles.FreeMoveHandle(point.handle1Position, HandleUtility.GetHandleSize(point.handle1Position) * 0.075f, Vector3.zero, Handles.CircleHandleCap);
            ...
            var fmh_98_76_638617347013789298 = Quaternion.identity; var newGlobal2 = Handles.FreeMoveHandle(point.handle2Position, HandleUtility.GetHandleSize(point.handle2Position) * 0.075f, Vector3.zero, Handles.CircleHandleCap);
